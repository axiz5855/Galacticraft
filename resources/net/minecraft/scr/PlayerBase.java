...
public abstract class PlayerBase
{
    ...
    public PlayerBase(PlayerAPI var1)
    {
        this.playerAPI = var1;
    ...
    {
        PlayerBase var6 = this.playerAPI.GetOverwrittenCanPlayerEdit(this);
        boolean var7;
    ...
    {
        PlayerBase var4 = this.playerAPI.GetOverwrittenDisplayGUIWorkbench(this);
    ...
    {
        PlayerBase var2 = this.playerAPI.GetOverwrittenDropOneItem(this);
        EntityItem var3;
    ...
    {
        PlayerBase var1 = this.playerAPI.GetOverwrittenGetMaxHealth(this);
        int var2;
    ...
    {
        PlayerBase var2 = this.playerAPI.GetOverwrittenInteract(this);
        boolean var3;
    ...
    {
        PlayerBase var1 = this.playerAPI.GetOverwrittenIsPlayerSleeping(this);
        boolean var2;
    ...
    {
        PlayerBase var2 = this.playerAPI.GetOverwrittenOnStruckByLightning(this);
    ...
    public void beforeUpdateCloak() {}

    public void updateCloak()
    {
        PlayerBase var1 = this.playerAPI.GetOverwrittenUpdateCloak(this);
    ...
    {
        PlayerBase var1 = this.playerAPI.GetOverwrittenUpdateRidden(this);
